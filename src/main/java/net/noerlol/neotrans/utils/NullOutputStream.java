...
public class NullOutputStream extends PrintStream {
     ...
     */
    public static NullOutputStream getNull() {
        return new NullOutputStream(new NullOS());
    }
    public NullOutputStream(@NotNull OutputStream out) {
        super(out);
    }
     ...
     */
    public NullOutputStream(@NotNull OutputStream out, boolean autoFlush) {
        super(out, autoFlush);
    }
     ...
     * @since 1.4
     */
    public NullOutputStream(@NotNull OutputStream out, boolean autoFlush, @NotNull String encoding) throws UnsupportedEncodingException {
     ...
     * @since 10
     */
    public NullOutputStream(OutputStream out, boolean autoFlush, Charset charset) {
     ...
     * @since 1.5
     */
    public NullOutputStream(@NotNull String fileName) throws FileNotFoundException {
        super(fileName);
    }
     ...
     * @since 1.5
     */
    public NullOutputStream(@NotNull String fileName, @NotNull String csn) throws FileNotFoundException, UnsupportedEncodingException {
        super(fileName, csn);
    }
     ...
     * @since 10
     */
    public NullOutputStream(String fileName, Charset charset) throws IOException {
     ...
     * @since 1.5
     */
    public NullOutputStream(@NotNull File file) throws FileNotFoundException {
        super(file);
    }
     ...
     * @since 1.5
     */
    public NullOutputStream(@NotNull File file, @NotNull String csn) throws FileNotFoundException, UnsupportedEncodingException {
        super(file, csn);
    }
     ...
     * @since 10
     */
    public NullOutputStream(File file, Charset charset) throws IOException {
        super(file, charset);
    }
}
